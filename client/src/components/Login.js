            ...
            <div className="login" >
                ...
                <form  >
                    <div className="form-group">
                        ...
                        <input type="email" onChange={this.handleInputChange} className="form-control" id="user_id" placeholder="Enter email" name="user_id"
                        ...
                        <input type="password" onChange={this.handleInputChange} className="form-control" id="password" placeholder="Enter password" name="password"
